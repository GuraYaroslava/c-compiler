...
for /L %%i in (27,1,39) do compiler -g generator/0%%i.in generator/0%%i.out
...
for /L %%i in (27,1,39) do C:\masm32\bin\Link /subsystem:console 0%%i.in.obj
for /L %%i in (27,1,39) do 0%%i.in.exe > 0%%i.out
