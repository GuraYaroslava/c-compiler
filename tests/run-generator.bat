...
for /L %%i in (10,1,70) do compiler -g generator/0%%i.in generator/0%%i.out
...
for /L %%i in (10,1,70) do C:\masm32\bin\Link /subsystem:console 0%%i.in.obj
for /L %%i in (10,1,70) do 0%%i.in.exe > 0%%i.out
